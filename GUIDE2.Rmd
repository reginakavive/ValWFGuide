...
Below are required parameters for different KPI calculations (Saito et al., 2022).
...
According to the KPIs of interest one can easily calculate KPI values as described by (Saito et al., 2022).
...
Visualizations as in the [<span style="color: red;font-weight: bold;">impact dashboard</span>](https://eia-transform.shinyapps.io/impact/).  
...
For the visualizations, we have a general and detailed view.
